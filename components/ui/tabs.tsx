...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-none bg-[#1A1A1A] p-1 text-[#A6A6A6]",
      className,
    )}
    {...props}
  />
